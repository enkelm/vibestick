...
**Mouse mode**:
An explicitly entered controller mode for pointer movement, clicking, dragging, and scrolling in place of ordinary app bindings; it remains selected across app-context changes.
